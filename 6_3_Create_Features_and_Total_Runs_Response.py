...
df_features = pd.read_excel('updated_stats22.xlsx')  # Adjust the path to your file
df_response = pd.read_excel('mlb_game_rosters22.xlsx')  # Adjust the path to your MLB game rosters file
...
df_response_selected = df_response[['game_id', 'total_runs']]
...
df_features_response.to_excel('total_runs_features_response22.xlsx', index=False)  # Adjust the path and filename as necessary
