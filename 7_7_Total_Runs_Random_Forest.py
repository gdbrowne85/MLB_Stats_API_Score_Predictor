...
# Create and train the Random Forest regression model with GridSearchCV
...
results_path = 'output_predictions_rf_regression.xlsx'  # Specify your desired output file name
results_df.to_excel(results_path, index=False)
print(f'Results saved to {results_path}')

# Save the best model to a file
model_path = 'best_rf_regression_model.joblib'
