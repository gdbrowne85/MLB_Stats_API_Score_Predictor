...
# Load data
boxscore_data = pd.read_excel('player_stats_from_boxscore24.xlsx')
roster_data = pd.read_excel('upcoming_mlb_games.xlsx')
...
# Process games
filtered_games = roster_data[(roster_data['game_date'] >= '2024-05-13') & (roster_data['game_date'] <= '2024-05-13')]
final_data = []
...
with pd.ExcelWriter('trailing_stats24.xlsx') as writer:
