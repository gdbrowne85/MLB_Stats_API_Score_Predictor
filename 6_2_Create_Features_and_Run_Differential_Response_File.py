...
df_response_selected = df_response[['game_id', 'run_differential']]
...
df_features_response.to_excel('regression_features_response23.xlsx', index=False)  # Adjust the path and filename as necessary
